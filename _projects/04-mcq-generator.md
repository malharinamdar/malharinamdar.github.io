...
In this project our initial idea was to implement the the system of mcq generation using T5 Tranformer model 
alongwith BERT encoder transformer based model to synthesise text and generate suitable questions using NLP techniques and We use the open source BERT model to analyse the text input, but due to the complexities involved and certain constraints I halted the idea.
